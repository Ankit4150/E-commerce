    ...
    <saction id="login">
        ...
        <div className='w-20 h-20 max-auto  '>
           ...
           <img src={login}alt="login.icons"/>
            ...
            <button className='bg-red-600 hover:bg-red-700 text-white px-6 py-2 w-full max-w-[115px] rounded-full hover:scale-110 transition-all mx-auto block mt-4'>Login</button>


            </form>
           
               <p className='mt-4'> Don't have account ? <Link to={"/sign-up"} className='text-red-600  hover:text-red-700  hover:underline'>Sign up </Link></p>
            </div>
        </div>
    </saction>
    </>
