...
export default function ProductDetails() {
 ...
 const handleMouseEnterProduct=async (imageURL)=>{
  ...
  return (
    <div className='container mx-auto p-4 '>
      <div className='min-h-[200px] flex flex-col  lg:flex-row gap-4'>
           ...
           {/*** details */}
              {
               ...
               <p className='bg-slate-200  rounded-full inline-block  animate-pulse h-6 w-full lg:h-8'></p>
               <h2 className='text-2xl lg:text-4xl font-medium animate-pulse h-6  lg:h-8 w-full bg-slate-200 rounded-full'></h2>
                 <p className='capitalize text-slate-400 animate-pulse bg-slate-200   lg:h-8 h-6 w-full rounded-full'> </p>
                 <div className=' text-red-600 bg-slate-200 items-center  h-6   lg:h-8 animate-pulse  gap-1 flex w-full'>
                 
                 </div>
                 
                
                   <div className='flex items-center gap-2 text-2xl lg:text-3xl my-1 font-medium h-6 animate-pulse w-full  lg:h-8'>
                   ...
                   <div className='flex items-center  gap-3 my-2  lg:h-8'>
                    <button className='bg-slate-200 h-6 rounded animate-pulse w-full  lg:h-8'></button>
                    <button   className='bg-slate-200 h-6 rounded animate-pulse w-full  lg:h-8'></button>
                   </div>

                   <div className='w-full  lg:h-8'>
                     <p className='text-slate-600 font-medium my-1 bg-slate-200 h-6 rounded animate-pulse w-full  lg:h-8'></p>
                     <p className='bg-slate-200 h-10 rounded animate-pulse w-full  lg:h-8'></p>
                   </div>
               ...
               <h2 className='text-2xl lg:text-4xl font-medium'>{data?.productName}</h2>
                 ...
                 <div className='text-red-500 items-center  gap-1 flex'>
                  <FaStar/>
                   <FaStar/>
                    <FaStar/>
                     <FaStar/>
                   ...
                   <div className='flex items-center  gap-3 my-2'>
                    ...
                    <button   className=' border-2 border-red-600 rounded  px-3 py-1  min-w-[100px]   text-red-600 font-medium hover:bg-red-600 hover:text-white'>Add To Cart</button>
                   </div>
       ...
       {
         data.category &&(
           <CategryWiseProductDisplay  category={data?.category} heading={" Recommended Product"}/>
         )
       }
